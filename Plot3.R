...
# Converting sub_metering_1, sub_metering_2, and sub_metering_3 variables to numeric 
...
# constructing a plot, adding two additional lines and saving it in png file
